...
vim.keymap.set("n", "<M-1>", function() harpoon:list():select(1) end, { noremap = true, silent = true, desc = 'harpoon 1' })
vim.keymap.set("n", "<M-2>", function() harpoon:list():select(2) end, { noremap = true, silent = true, desc = 'harpoon 2' })
vim.keymap.set("n", "<M-3>", function() harpoon:list():select(3) end, { noremap = true, silent = true, desc = 'harpoon 3' })
vim.keymap.set("n", "<M-4>", function() harpoon:list():select(4) end, { noremap = true, silent = true, desc = 'harpoon 4' })
vim.keymap.set("n", "<M-5>", function() harpoon:list():select(5) end, { noremap = true, silent = true, desc = 'harpoon 5' })
vim.keymap.set("n", "<M-6>", function() harpoon:list():select(6) end, { noremap = true, silent = true, desc = 'harpoon 6' })
vim.keymap.set("n", "<M-7>", function() harpoon:list():select(7) end, { noremap = true, silent = true, desc = 'harpoon 7' })
vim.keymap.set("n", "<M-8>", function() harpoon:list():select(8) end, { noremap = true, silent = true, desc = 'harpoon 8' })
vim.keymap.set("n", "<M-9>", function() harpoon:list():select(9) end, { noremap = true, silent = true, desc = 'harpoon 9' })
vim.keymap.set("n", "<M-0>", function() harpoon:list():select(10) end, { noremap = true, silent = true, desc = 'harpoon 10' })
require("ibl").setup()
