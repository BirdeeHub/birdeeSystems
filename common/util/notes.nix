{
  graph = [
    ...
    {
      disabled = false;
      file = "/nix/store/fwq3ggyxrfgn3xis0zm545kd3vy8j18j-source/parts.nix";
      imports = [
        {
          disabled = false;
          file = "/nix/store/fwq3ggyxrfgn3xis0zm545kd3vy8j18j-source/lib/core.nix";
          imports = [ ];
          key = "/nix/store/fwq3ggyxrfgn3xis0zm545kd3vy8j18j-source/lib/core.nix";
        }
      ];
      key = ":anon-2";
    }
    ...
    {
      disabled = false;
      file = "/nix/store/ghjya315dqmcig1gq0c67h46d9av3p0v-source/common/wrappers";
      imports = [
        {
          disabled = false;
          file = "/nix/store/ghjya315dqmcig1gq0c67h46d9av3p0v-source/common/wrappers/git";
          imports = [
            {
              disabled = false;
              file = "/nix/store/fwq3ggyxrfgn3xis0zm545kd3vy8j18j-source/wrapperModules/g/git/module.nix";
              imports = [
                {
                  disabled = false;
                  file = "/nix/store/fwq3ggyxrfgn3xis0zm545kd3vy8j18j-source/modules/default/module.nix";
                  imports = [
                    {
                      disabled = false;
                      file = "/nix/store/fwq3ggyxrfgn3xis0zm545kd3vy8j18j-source/modules/symlinkScript/module.nix";
                      imports = [ ];
                      key = "/nix/store/fwq3ggyxrfgn3xis0zm545kd3vy8j18j-source/modules/symlinkScript/module.nix";
                    }
                    {
                      disabled = false;
                      file = "/nix/store/fwq3ggyxrfgn3xis0zm545kd3vy8j18j-source/modules/makeWrapper/module.nix";
                      imports = [
                        {
                          disabled = false;
                          file = "/nix/store/fwq3ggyxrfgn3xis0zm545kd3vy8j18j-source/modules/makeWrapper/module.nix";
                          imports = [ ];
                          key = "/nix/store/fwq3ggyxrfgn3xis0zm545kd3vy8j18j-source/modules/makeWrapper/module.nix:anon-1";
                        }
                      ];
                      key = "/nix/store/fwq3ggyxrfgn3xis0zm545kd3vy8j18j-source/modules/makeWrapper/module.nix";
                    }
                  ];
                  key = "/nix/store/fwq3ggyxrfgn3xis0zm545kd3vy8j18j-source/modules/default/module.nix";
                }
              ];
              key = "/nix/store/fwq3ggyxrfgn3xis0zm545kd3vy8j18j-source/wrapperModules/g/git/module.nix";
            }
          ];
          key = "/nix/store/ghjya315dqmcig1gq0c67h46d9av3p0v-source/common/wrappers/git";
        }
      ];
      key = ":anon-4";
    }
  ...
  meta = {
    "/nix/store/fwq3ggyxrfgn3xis0zm545kd3vy8j18j-source/lib/core.nix" = {
      description = { };
      file = "/nix/store/fwq3ggyxrfgn3xis0zm545kd3vy8j18j-source/lib/core.nix";
      maintainers = [
        {
    ...
    "/nix/store/fwq3ggyxrfgn3xis0zm545kd3vy8j18j-source/modules/default/module.nix" = {
      description = {
    ...
    "/nix/store/fwq3ggyxrfgn3xis0zm545kd3vy8j18j-source/modules/makeWrapper/module.nix" = {
      description = {
    ...
    "/nix/store/fwq3ggyxrfgn3xis0zm545kd3vy8j18j-source/modules/symlinkScript/module.nix" = {
      description = {
    ...
    "/nix/store/fwq3ggyxrfgn3xis0zm545kd3vy8j18j-source/wrapperModules/g/git/module.nix" = {
      description = {
